...
import pickle
# 进行数据读取
with open("/home/zhangyinan/TXL_new/14_stlearn/Control3_Model1_Treatment2/result/model1/cci_result.pk","rb") as file:
...
# 保存预测后的结果
pickle.dump(adata, open('/home/zhangyinan/TXL_new/14_stlearn/Control3_Model1_Treatment2/result/model1/cci_predict_result.pk', 'wb'))
