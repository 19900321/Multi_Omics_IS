...
import pickle
# 进行数据读取
with open("/home/zhangyinan/TXL_new/14_stlearn/Control5_Model2_Treatment3/result/control5/cci_result.pk","rb") as file:
...
# 保存预测后的结果
pickle.dump(adata, open('/home/zhangyinan/TXL_new/14_stlearn/Control5_Model2_Treatment3/result/control5/cci_predict_result.pk', 'wb'))
